...
#define SC(kc)     (kc | QK_LCTL | QK_LSFT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |----------------------------------------------------------------------------------------|
     * | IME OFF |  Z  |  X  |  C  |  V  |  B  |  N  |  M  |  ,  |  .  |  /  |  IME_ON  | MO(R) |
     * `----------------------------------------------------------------------------------------'
     *         | LCtl |  LAlt  |            Shift & Space              |  RAlt | RGUI |
     *         `----------------------------------------------------------------------'
     *
     */
    [_BASE] = LAYOUT_60_hhkb(
        ...
        IME_OFF,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, IME_ON,  MO(_R),
                 KC_LCTL, KC_LALT,                   LSFT_T(KC_SPC),                              KC_RALT, KC_RGUI),
     ...
     * |----------------------------------------------------------------------------------------|
     * | LShift  |  Z  |  X  |  C  |  V  |  B  |  N  |  M  |  ,  |  .  |  /  |  IME ON  | _BASE |
     * `----------------------------------------------------------------------------------------'
     *         |  K  |   L   |                 Space                   |  RAlt | RGUI |
     *         `----------------------------------------------------------------------'
     */
    [_GAME] = LAYOUT_60_hhkb( // TO(1) : for FPS Game
        KC_ESGR, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_F12,   KC_BSDL,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
        LT(_L,KC_M),KC_A, KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, IME_ON,  KC_BASE,

                 KC_K,    KC_L,                      KC_SPC,                                  KC_RALT, KC_RGUI),

    /*  F10 & F10 :-(
     * ,----------------------------------------------------------------------------------------.
     * | RSET|  F1 |  F2 |  F3 |  F4 |  F5 |  F6 |  F7 |  F8 |  F9 | F10 | F10 | F11 | F12 | Del|
     * |----------------------------------------------------------------------------------------|
     * | G-Tab|S-C-q| G-w |     |     |     |     |     |S-Ins|     | PrScr| Home | End | Pipe  |
     * |----------------------------------------------------------------------------------------|
     * |       |S-A-a|S-G-s|     |     |     |  ← |  ↓ |  ↑ |  → |     |S-C-'|     Enter    |
     * |----------------------------------------------------------------------------------------|
     * | LCtrl   |     |     | G-k |     |     | C-n | A-n | PgUp| PgDn|     | IME OFF  |       |
     * `----------------------------------------------------------------------------------------'
     *         |     |       |                  Space                 | S-C-t | S-C-r |
     *         `----------------------------------------------------------------------'
     */
    [_L] = LAYOUT_60_hhkb( // MO(2) : left side modifer
        RESET,    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,   KC_F10,   KC_F11,  KC_F12, KC_DEL,
        G(KC_TAB),CS(KC_Q),G(KC_W), ___,     ___,     ___,     ___,     ___,     S(KC_INS),___,     KC_PSCR,  KC_HOME,  KC_END,  KC_PIPE,
        ___,      SA(KC_A),SG(KC_S),___,     ___,     ___,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,  ___,      SC(KC_QUOT),       ___,
        KC_LCTL,           ___,     ___,     G(KC_K),     ___,     ___,     C(KC_N), A(KC_M), KC_PGUP,  KC_PGDN,  ___,      IME_OFF, ___,
                  ___,     ___,                           ___,                                      SC(KC_T),SC(KC_R)),

    /*  R2, R3 : MediaKey + LED, Shift-Win-LR
     * ,----------------------------------------------------------------------------------------.
    ...
    [_R] = LAYOUT_60_hhkb( // MO(3) : right side modifer
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  ___,   CA(KC_DEL),
        ...
        ___,              KC_VOLD, KC_VOLU, G(KC_K), ___,     ___,     ___,     ___,     ___,     ___,     G(KC_K), TO(_GAME), ___,
                 SG(KC_LEFT),___,                        S(KC_SPC),                              ___,      SG(KC_RGHT)),
