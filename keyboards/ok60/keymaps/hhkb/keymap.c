...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |----------------------------------------------------------------------------------------|
     * | Shift  |  Z  |  X  |  C  |  V  |  B  |  N  |  M  |  ,  |  .  |  /  |  IME ON   | MO(2) |
     * `----------------------------------------------------------------------------------------'
    ...
    KEYMAP(
        ...
        KC_LSFT,  XXXXX,  KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,  KC_DOT,   KC_SLSH,  XXXXX,   IME_ON,  MO(2),
    ...
    KEYMAP( // MO(2) : right side modifer
        ...
        _____,   _____,   _____,   _____,   _____,   _____,   _____,   _____,   _____,   _____, _____,  _____,  _____,  IME_OFF, _____,
